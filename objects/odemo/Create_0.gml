...
my_panel.add_content([
	...
	new LuiText( , , , , "Звук животных: "),
	new LuiProgressBar( , , 200, , 0, 100, true, 50, function(){print("Dragging: ", self.value)}),
	new LuiText( , , , , "Звук монстров: "),
	new LuiProgressBar( , , 200, , 0, 100, true, 75, function(){print("Dragging: ", self.value)}),
	
	demo_loading,
	
	
	new LuiButton(my_panel.x + 16, my_panel.height - 32, , , "Показать", function() {
			var _msg = new LuiMessage( , , "TEST TEST TEST TEST");
		}),
	new LuiButton(my_panel.x + my_panel.width - 128 - 16, my_panel.height - 32, , , "Выход", function() {game_end()})
]);
