...
my_panel.add_content([
	...
	new LuiText( , , LUI_STRETCH, , "Progress loading"),
	
	new LuiButton( , my_panel.height - 32 - 16, , , "Show message", function() {
