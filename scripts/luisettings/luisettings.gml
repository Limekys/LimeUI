//Info
#macro LIMEUI_VERSION "2025.01.29"
...
//Settings
#macro LUI_GRID_SIZE					96		// UI grid size for elements
#macro LUI_GRID_ACCURACY				96		// Same as grid size is good, but you can use low size for pixel styles ui maybe...
